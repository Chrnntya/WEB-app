...
<?php $this->section('content'); ?>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="align-middle" style="color: red;">
                                                        <button class="btn btn-sm btn-danger"  title="Hapus data" onclick="hapus_admin('<?= $data->userid; ?>')">Hapus</button>
                                                    </td> -->
    ...
    <script>
        ...
        function hapus_admin(userid) {
            pesan = confirm('Yakin akan hapus data?');
            if (pesan) {
                window.location=('/datauser/hapus_admin/'+userid);
            }else{
                return false;
            }
        }
