        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
		    ...
		    <li class="nav-item">
		        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTri" aria-expanded="true" aria-controls="collapseTri">
		            <i aria-hidden="true" role="presentation" class="fa fa-chart-line q-icon notranslate"> </i>
		            <span>Laporan</span>
		        </a>
		        <div id="collapseTri" class="collapse" aria-labelledby="headingTri" data-parent="#accordionSidebar">
		            <div class="bg-white py-2 collapse-inner rounded">
		                ...
		                <a class="collapse-item" href="<?= base_url('laporan/rekapitulasi'); ?>">
		                    <i aria-hidden="true" role="presentation" class="fa fa-bar-chart q-icon notranslate"> </i>
		                    Rekapitulasi Stock
		                </a>
		    ...
		    <li class="nav-item">
		        ...
		        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
		            <div class="bg-white py-2 collapse-inner rounded">
		                ...
		                <a class="collapse-item" href="<?= base_url('datauser/index'); ?>">
		                    <i aria-hidden="true" role="presentation" class="fa fa-user-md q-icon notranslate"> </i>
		                    Super Admin
		                </a>
		                <a class="collapse-item" href="<?= base_url('datauser/dataadmin'); ?>">
		                    <i aria-hidden="true" role="presentation" class="fa fa-user q-icon notranslate"> </i>
		                    Admin
		                </a>
		                <a class="collapse-item" href="<?= base_url('datauser/datapegawai'); ?>">
		                    <i aria-hidden="true" role="presentation" class="fa fa-user-o q-icon notranslate"> </i>
		                    Pegawai
		                </a>
		            </div>
