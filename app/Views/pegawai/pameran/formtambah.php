                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body py-3">
                                <?= form_button('','<i class="fa fa-arrow-left"></i> Kembali', [
                                    ...
                                    'onclick' => "location.href=('".base_url('pegawai/pameran')."')"
                                ]) ?>

                            </div>
                            <div class="card-body col-md-6 justify-content-center">
                                <?= form_open('pegawai/simpandata_pameran') ?>
                                <?php 
                                    $nomor = 1;
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="keterangan_pameran" id="keterangan_pameran" for="keterangan" placeholder="Isikan keterangan">
                                </div>
