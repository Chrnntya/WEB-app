                            ...
                            <div class="card-body col-md-6 justify-content-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="kodestok" id="kodestok">
                                        ...
                                        ?>
                                        <option class="form-control" value="<?= $stok['kodestok']; ?>"><?= $stok['merks']." - ".$stok['tipekendaraan']." - ".$stok['subtipe']." - ".$stok['warna']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input id="terjual" class="form-control" type="hidden" name="terjual" value="1"/>
